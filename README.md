...
| `Админ` ...   | Отдельные столбцы для каждого чата (Админ, Маркировка ЧЗ, Декларанты,    |
|               | Декларанты СН, Техподдержка, Фулфилмент, Финансы, Логистика). Отметьте   |
|               | любое непустое значение, чтобы выдать доступ.                            |

### Таблица2 (чаты)

| Колонка     | Описание                                            |
| ----------- | --------------------------------------------------- |
| `chat_name` | Название чата, совпадает с заголовком в `Таблица1`.  |
